...
namespace Spark::RHI
{
    using PipelineStateHash = size_t;
    ...
    struct PipelineStateEntry
    {
        ...
        using PipelineStateDescriptorVariant = eastl::variant<PipelineStateDescriptorForDraw, PipelineStateDescriptorForDispatch, PipelineStateDescriptorForRayTracing>;
    ...
    using PipelineStateSet = eastl::unordered_set<PipelineStateEntry, PipelineStateCacheHash>;
    ...
    public:
        ...
        PipelineLibraryIndex CreateLibrary(
            const eastl::unordered_map<int, ConstPtr<PipelineLibraryData>>& serializedData,
            const eastl::unordered_map<int, eastl::string>& filePaths);
        */
        PipelineLibraryIndex CreateLibrary();
        ...
        const PipelineState* AcquirePipelineState(
            PipelineLibraryIndex library, const PipelineStateDescriptor& descriptor, const ObjectName& name);
    ...
    private:
        ...
        using ThreadLibrarySet = eastl::array<ThreadLibraryEntry, LibraryCountMax>;
        ...
        eastl::bitset<LibraryCountMax> m_globalLibraryActiveBits;
        ...
        eastl::fixed_vector<PipelineLibraryIndex, LibraryCountMax> m_libraryFreeList;
    };
}