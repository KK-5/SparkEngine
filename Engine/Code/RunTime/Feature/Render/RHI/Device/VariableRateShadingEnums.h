...
{       
    ...
    {
        None = 0,
        PerDraw = BIT(static_cast<uint32_t>(ShadingRateType ::PerDraw)),
        PerPrimitive = BIT(static_cast<uint32_t>(ShadingRateType ::PerPrimitive)),
        PerRegion = BIT(static_cast<uint32_t>(ShadingRateType ::PerRegion)),
    ...
    {
        None = 0,
        Rate1x1 = BIT(static_cast<uint32_t>(ShadingRate ::Rate1x1)),
        Rate1x2 = BIT(static_cast<uint32_t>(ShadingRate ::Rate1x2)),
        Rate2x1 = BIT(static_cast<uint32_t>(ShadingRate ::Rate2x1)),
        Rate2x2 = BIT(static_cast<uint32_t>(ShadingRate ::Rate2x2)),
        Rate2x4 = BIT(static_cast<uint32_t>(ShadingRate ::Rate2x4)),
        Rate4x2 = BIT(static_cast<uint32_t>(ShadingRate ::Rate4x2)),
        Rate4x1 = BIT(static_cast<uint32_t>(ShadingRate ::Rate4x1)),
    ...
    using ShadingRateCombinators = eastl::array<ShadingRateCombinerOp, 2>;
