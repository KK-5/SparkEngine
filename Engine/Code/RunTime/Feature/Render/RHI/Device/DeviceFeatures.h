...
namespace Spark::Render::RHI
{
    struct DeviceFeatures
    {
        ...
        //eastl::array<QueryTypeFlags, HardwareQueueClassCount> m_queryTypesMask = { { QueryTypeFlags::None, QueryTypeFlags::None, QueryTypeFlags::None } };
        ...
        ShadingRateTypeFlags m_shadingRateTypeMask = ShadingRateTypeFlags::None;

        //! Supported values for setting the shading rate.
        ShadingRateFlags m_shadingRateMask = ShadingRateFlags::None;
        ...
        ScalingFlags m_swapchainScalingFlags = ScalingFlags::None;
