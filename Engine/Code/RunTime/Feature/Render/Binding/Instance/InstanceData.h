...
namespace Spark::Render
{
    ...
    struct InstanceData
    {
        ...
        Math::Matrix4X4 m_prevModel{Math::Matrix4X4Const::IDENTITY};    // last frame's m_model (64B)
    ...
    // `float4x4 Model; float4x4 PrevModel; float4x4 NormalMatrix; uint MaterialIndex; uint3 _Pad;`.
