...
#include <Resource/Material/StandardPBR.h>   // MaterialTexSlotCount / MaterialTexSlot
...
namespace Spark::Render
{
    ...
    //!
    //! Assembled each frame by MaterialBindingSystem from Resource::StandardPBR.
    ...
    struct MaterialData
    {
        ...
        uint32_t      m_texIndices[Resource::MaterialTexSlotCount];
    ...
    static_assert(Resource::MaterialTexSlotCount == 5,
