...
#include <RHI/Device/VariableRateShadingEnums.h>
...
namespace Spark::RHI
{
    ...
    {
        using StateList = eastl::fixed_vector<T, RHI::Limits::Pipeline::AttachmentColorCountMax>;
        void Set(eastl::span<const T> newElements)
        {
