...
namespace Spark::RHI
{
    ...
    using PipelineLibraryIndex = uint32_t;

    static const PipelineLibraryIndex InvalidPipelineLibraryIndex = static_cast<uint32_t>(-1);
    ...
    public:
        ...
        //! ResultCode MergeInto(eastl::span<const PipelineLibrary* const> librariesToMerge);
        ...
        //! bool SaveSerializedData(const eastl::string& filePath) const;
    ...
    private:
        ...
        /// virtual ResultCode MergeIntoInternal(eastl::span<const PipelineLibrary* const> libraries) = 0;
