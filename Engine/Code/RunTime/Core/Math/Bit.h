...
#ifndef BIT_MASK
#define BIT_MASK(BitCount) (BIT(BitCount) - 1u)
#endif

#ifndef BIT_MASK_OFFSET
#define BIT_MASK_OFFSET(BitCount, BitOffset) (BIT_MASK(BitCount) << BitOffset)
#endif
...
namespace Spark
{
    ...
    {
        return v & static_cast<T>(~BIT(bitIndex));
    }
    ...
    {
        return (v & static_cast<T>(BIT(bitIndex))) != static_cast<T>(0);
    }
